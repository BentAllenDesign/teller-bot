...
//@Service
public class ReadTicketsListener extends ReadResponses implements EventListener<MessageCreateEvent> {
    @Override
    ...
    public Mono<Void> execute(MessageCreateEvent event) {
        ...
        return readTicketsCommand(event.getMessage(), event.getMember().get());
    }
}
