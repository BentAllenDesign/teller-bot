...
//@Service
public class ReadAllTicketsListener extends ReadResponses implements EventListener<MessageCreateEvent> {
    @Override
    ...
    public Mono<Void> execute(MessageCreateEvent event) {
        ...
        return readAllTicketsCommand(event.getMessage(), event.getMember().get());
    }
}
